...
void main()
{
        ...
        fp=fopen("/home/gg/Desktop/test_py/te.py","r");
        if(fp == NULL)
        {
        ...
        {
                fpp=fopen("/home/gg/Desktop/test_py/ok.py","w");//new file creation.This is the simplevirus file.
                fclose(fpp);
                printf("file creation done");
                fpp=fopen("/home/gg/Desktop/test_py/ok.py","a");
                while(c != EOF)
                {
                        c=getc(fp);
